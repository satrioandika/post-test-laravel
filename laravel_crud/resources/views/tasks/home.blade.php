...
<div class="hero-section">
    <div class="container mt-5">
        <h1 class="display-4">Selamat datang di Aplikasi Manajemen Tugas</h1>
        <p class="lead">Solusi lengkap Anda untuk mengelola informasi Tugas dengan efisien.</p>
        <a href="{{ route('tasks.index') }}" class="btn btn-primary btn-lg mt-3">Lihat Produk</a>
    </div>
</div>
